...
import '/presentation/screens/my_reminders/my_reminders_screen.dart';
        ...
        actions: [
          ...
          PopupMenuButton<String>(
            icon: const Icon(Icons.more_vert,
                color: kContrastColor, size: kMediumIconSize),
            itemBuilder: (context) => [
                      ...
                      actions: [
                        ...
                        ElevatedButton(
                          ...
                          child: const Text(
                            'Crear Cuenta',
                            style: TextStyle(
                                fontSize: kSmallFontSize, color: kWhiteColor),
                          ),
                        ),
                        ElevatedButton(
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15), // Más espacio antes de los consejos
      ...
      child: InkWell(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(
              horizontal: kLargePadding, vertical: 30),
          child: Row(
            children: [
              Container(
            ...
            Row(
              children: const [
                Icon(Icons.lightbulb_outline,
                    color: Color(0xFFF39C12), size: 30),
                SizedBox(width: 12),
                Text(
                  'Mejora tu Postura',
                  style: TextStyle(
